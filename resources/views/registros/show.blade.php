<x-app-layout>
    ...
    <div class="container mt-5">
        <div class="text-center">
            ...
            <!-- Nombre del registro -->
            <h3 class="mt-3 mb-3" style="color: #001F3F; font-size: 2.2rem; font-weight: 700;">
            ...
            <div class="details mb-4">
                <p class="card-text" style="font-size: 1.1rem; color: #555;">
                    Edad: <span style="font-weight: 600;">{{ $record->edad }} años</span>
                </p>
                <p class="card-text" style="font-size: 1.1rem; color: #555;">
                    Documento: <span style="font-weight: 600;">{{ $record->documento }}</span>
                </p>
                <p class="card-text" style="font-size: 1.1rem; color: #555;">
                    Email: <span style="font-weight: 600;">{{ $record->email }}</span>
                </p>
            </div>

            <a href="{{ route('registro.edit', $record->id) }}" class="btn btn-primary mt-3">Editar</a>

            <!-- Botón de eliminación, activa el modal -->
